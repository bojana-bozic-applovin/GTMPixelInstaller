...
**Self-built frontend (GTM in code):** [SELF_BUILT_GTM.md](./SELF_BUILT_GTM.md) · user overview in the [root README](../../README.md#self-built-frontends-install-gtm-in-code)
